...
/**
 * Rock, Paper, Scissors, Lizard, and Spock  class
...
public class RPSLSpock {
    ...
    /**
     * Boolean method: to make sure the input is not null, and if the statement true or false
    ...
    /**
     * This method for generating one choice randomly
